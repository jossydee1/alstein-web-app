        ...
        <section className="space-y-7 text-center">
          ...
          <div className="grid grid-cols-2 items-center justify-center gap-7 md:grid-cols-4">
            <Image
              ...
              width="276"
              height="276"
              className="aspect-square h-auto w-[276px] rounded-[30px] object-cover md:order-1 md:w-full"
            />
            <Image
              src={image2}
              alt=""
              width="276"
              height="218"
              className="h-auto w-[276px] rounded-[30px] object-cover md:order-2 md:w-full"
            />
            <Image
              src={image4}
              alt=""
              width="276"
              height="276"
              className="h-auto w-[276px] rounded-[30px] object-cover md:order-4 md:w-full"
            />
            <Image
              src={image3}
              alt=""
              width="276"
              height="228"
              className="aspect-square h-auto w-[276px] rounded-[30px] object-cover md:order-3 md:w-full"
            />
          </div>
